    ...
    <div class="search_all">
      <div>
        ...
        <div class="filter-container">
          手机号:
          <el-input v-model="formData.uMobile" placeholder="请输入手机号" style="width: 200px;" class="filter-item"  oninput = "value=value.replace(/[^\d]/g,'')" maxlength="11" @blur="testPhone()" />
        </div> 
        <div class="filter-container">
          姓名:
      ...
      <div>
        ...
        <el-button @click="$router.go(-1)" type="success">上一页</el-button> 
      </div>
    </div>
    ...
    <el-table-column align="center" label="操作">
      <template slot-scope="scope"> 
        ...
        <el-button
          type="danger"
          size="mini"
          @click="celent_delet(scope.$index, scope.row)">撤销</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 分页 -->
    ...
    methods: {
      initData() {
        ...
        celentUserList.then(res => {
          ...
          if (this.formData.uMobile == null || this.formData.uMobile.length < 11 || this.formData.uMobile.test(TEL_REGEXP)) {   
