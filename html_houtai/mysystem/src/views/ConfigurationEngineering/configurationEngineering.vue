...
export default {
    ...
    methods: {
      ...
      celent_more(index, row) {
         this.$router.push({ path: 'decorateDetails', query: {uNick_NameTwo: row.uRealName}})
         this.$store.commit('addEngineer',row.uRealName); 
         this.$store.commit('addEngineerID',row.uid); 
