...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      if (!storyMenu.includes("工长管理-工长详情")) {
        this.showEdit = false;
      }
      if (!storyMenu.includes("工长管理-回收站")) {
        this.recycles = false;
      }
      if (!storyMenu.includes("工长管理-新建")) {
        this.showPage = false;
      }
      if (!storyMenu.includes("工长管理-修改")) {
        this.editorData = false;
      }
      if (!storyMenu.includes("工长管理-删除")) {
    ...
    recycle() {
      this.$router.push({ path: "shopListRecycle" });
    },
