...
<div>
    ...
    <el-table-column align="center" label="操作">
      <template slot-scope="scope">
        ...
        v-show="showEdit"
          size="mini"
          @click="celent_more(scope.$index, scope.row)">工长详情</el-button> -->
        <el-button
          type="danger"
          size="mini"
          plain 
...
<!-- 恢复提示 -->
  ...
  width="30%">
  <span>是否确认恢复？ 恢复信息后可到“工长列表”查看并编辑被恢复的信息</span>
...
export default {
    ...
    methods: {
      ...
      //   console.log(row.uid)
      //    this.$router.push({ path: 'masterDetails', query: { restaurant_id: row.uid }})
